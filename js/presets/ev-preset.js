// EV preset — original ev-tracker categories.
// `extraFields` declares which optional record fields the form should reveal
// when this category is selected (replaces the hard-coded '充電' check).
export const PRESET_NAME = 'EV 電動車';

export const CATEGORIES = {
  // Recurring / daily
  充電: { color: '#378ADD', bg: '#E6F1FB', icon: 'bolt', type: 'r', extraFields: ['kwh', 'odo'] },
